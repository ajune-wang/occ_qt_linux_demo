	...
	myContext = theContext;
	{
		...
		hAISContext->SetDisplayMode(AIS_Shaded, true);   //设置显示模式为遮蔽
		{
			...
			{	//XYZ坐标系
                ...
                Handle(Graphic3d_TransformPers) aPer = new Graphic3d_TransformPers(Graphic3d_TransModeFlags::Graphic3d_TMF_ZoomPers);
                hAISContext->SetTransformPersistence(Trihedron,aPer);//禁止缩放
			}
		}
